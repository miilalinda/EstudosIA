...
<div class="titulo-grupo">
    <img src="https://i.pinimg.com/736x/e2/d2/19/e2d219c83bd9741d6f35a8daab064355.jpg">
    <h2>Animes</h2>
</div>
...
<form action="enviar_mensagem_animes.php" method="POST" enctype="multipart/form-data">
...
<div class="msg">
    ...
    <form action="excluir_mensagem_animes.php" method="POST" style="display:inline;">
