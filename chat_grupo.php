...
<div class="titulo-grupo">
    <img src="https://i.pinimg.com/1200x/e4/6d/1a/e46d1add185e813f4cc36b417128647f.jpg">
...
<div class="msg">
    ...
    <?php else: ?>
        <a href="<?= $msg['arquivo'] ?>" target="_blank" 
           style="color:#2d5c54;font-weight:bold;">
           📎 Abrir arquivo
        </a>
    <?php endif; ?>
<?php endif; ?>
    ...
    <form action="excluir_mensagem.php" method="POST" style="display:inline;">
        <input type="hidden" name="id" value="<?= $msg['id'] ?>">
        <button class="botao-excluir">Excluir</button>
    </form>
    <?php endif; ?>

    <!-- RESPOSTAS — TODAS APARECEM PARA TODOS -->
