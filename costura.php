...
<div class="titulo-grupo">
    <img src="https://i.pinimg.com/1200x/7a/0f/d6/7a0fd63c19604cd60b7ac8d97db730c2.jpg">
    <h2>Costura e Crochê</h2>
</div>

<br>

<!-- FORMULÁRIO PRINCIPAL -->
<form action="enviar_mensagem_costura.php" method="POST" enctype="multipart/form-data">
...
<div class="msg">
    ...
    <?php if($msg['arquivo']): ?>
        ...
        <?php else: ?>
            <a href="<?= $msg['arquivo'] ?>" target="_blank" style="color:#2d5c54;font-weight:bold;">
                📎 Abrir arquivo
            </a>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <form action="excluir_mensagem_costura.php" method="POST" style="display:inline;">
